...
public class DatabaseContactos extends SQLiteOpenHelper {
    ...
    // TODO: El método onCreate se llama al crear
    // la base de datos
    @Override
    ...
    // TODO: Usamos un metodo para crear nuestras tablas
    // Con el parametro db "SQLiteDatabase" ejecutamos
    // una instruccion SQL para crear nuestra tabla.
    private void createTables(SQLiteDatabase db) {
        db.execSQL(CREATE_TABLE_CONTACTOS);
    }

    // TODO: Usamos este método para eliminar nuestras
    // tablas.
